...
notify-send "Your RAM is freed upto $(echo "$freemem_after - $freemem_before" | bc) MB" "Now you have $freemem_after MB of free RAM."  -i /home/ist/nitin/Images/MY_RAM.png
exit 0
